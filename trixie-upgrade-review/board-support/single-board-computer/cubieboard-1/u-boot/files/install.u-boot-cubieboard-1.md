# u-boot installation for cubieboard-1
...
. The commands are run on the target board (cubieboard-1)
...
sudo dd if=/boot/u-boot/u-boot-cubieboard-1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
