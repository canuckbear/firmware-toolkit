# u-boot installation for orangepi-rv2
...
. The commands are run on the target board (orangepi-rv2)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-rv2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
