# u-boot installation for raspberry-pi0w-2
...
/boot/u-boot/u-boot-raspberry-pi0w-2

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-raspberry-pi0w-2.VERSION
...
. The commands are run on the target board (raspberry-pi0w-2)
...
sudo dd if=/boot/u-boot/u-boot-raspberry-pi0w-2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
