# u-boot installation for orangepi-4
...
. The commands are run on the target board (orangepi-4)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-4 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
