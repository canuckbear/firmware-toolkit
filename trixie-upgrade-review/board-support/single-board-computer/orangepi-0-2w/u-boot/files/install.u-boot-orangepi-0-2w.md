# u-boot installation for orangepi-0-2w
...
. The commands are run on the target board (orangepi-0-2w)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-0-2w of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
