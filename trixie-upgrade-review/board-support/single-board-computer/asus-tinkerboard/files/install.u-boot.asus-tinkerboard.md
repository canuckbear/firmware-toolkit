# u-boot installation for asus-tinkerboard
...
/boot/u-boot/u-boot-asus-tinkerboard

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-asus-tinkerboard.VERSION
...
. The commands are run on the target board (asus-tinkerboard)
...
# sudo dd if=/boot/u-boot/u-boot-asus-tinkerboard of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
