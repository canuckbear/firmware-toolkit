# u-boot installation for nanopi-r2c
...
. The commands are run on the target board (nanopi-r2c)
...
sudo dd if=/boot/u-boot/u-boot-nanopi-r2c of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
