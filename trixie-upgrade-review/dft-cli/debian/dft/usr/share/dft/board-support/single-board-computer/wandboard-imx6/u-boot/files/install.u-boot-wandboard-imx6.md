# u-boot installation for wandboard-imx6
...
. The commands are run on the target board (wandboard-imx6)
...
sudo dd if=/boot/u-boot/u-boot-wandboard-imx6 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
