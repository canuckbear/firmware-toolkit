# u-boot installation for creator-ci20
...
. The commands are run on the target board (creator-ci20)
...
sudo dd if=/boot/u-boot/u-boot-creator-ci20 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
