# u-boot installation for orangepi-r1-plus
...
/boot/u-boot/u-boot-orangepi-r1-plus

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-orangepi-r1-plus.VERSION
...
. The commands are run on the target board (orangepi-r1-plus)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-r1-plus of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
