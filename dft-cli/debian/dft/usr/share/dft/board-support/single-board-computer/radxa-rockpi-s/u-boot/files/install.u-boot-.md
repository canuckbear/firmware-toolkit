# u-boot installation for radxa-rockpi-s
...
. The commands are run on the target board (radxa-rockpi-s)
...
sudo dd if=/boot/u-boot/u-boot-radxa-rockpi-s of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
