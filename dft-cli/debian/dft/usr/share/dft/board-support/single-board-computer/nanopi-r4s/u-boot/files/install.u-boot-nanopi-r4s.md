# u-boot installation for nanopi-r4s
...
. The commands are run on the target board (nanopi-r4s)
...
sudo dd if=/boot/u-boot/u-boot-nanopi-r4s of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
