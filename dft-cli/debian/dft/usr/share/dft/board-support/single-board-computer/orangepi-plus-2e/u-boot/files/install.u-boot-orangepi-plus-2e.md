# u-boot installation for orangepi-plus-2e
...
/boot/u-boot/u-boot-orangepi-plus-2e

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-orangepi-plus-2e.VERSION
...
. The commands are run on the target board (orangepi-plus-2e)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-plus-2e of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
