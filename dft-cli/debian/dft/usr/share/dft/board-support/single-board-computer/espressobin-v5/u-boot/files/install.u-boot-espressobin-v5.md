# u-boot installation for espressobin-v5
...
. The commands are run on the target board (espressobin-v5)
...
sudo dd if=/boot/u-boot/u-boot-espressobin-v5 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
