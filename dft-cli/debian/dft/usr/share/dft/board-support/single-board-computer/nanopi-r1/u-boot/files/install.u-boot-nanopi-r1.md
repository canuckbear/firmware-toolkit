# u-boot installation for nanopi-r1
...
. The commands are run on the target board (nanopi-r1)
...
sudo dd if=/boot/u-boot/u-boot-nanopi-r1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
