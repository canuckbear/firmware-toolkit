...
dft-os-lxc-container : Install and configure LXC software inside a container, and only inside the container.
Otherwise it has to be done by hypervisor role on host node)
