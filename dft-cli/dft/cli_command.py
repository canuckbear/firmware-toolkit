...
# TODO remove the imported pubkey from gnupg
  ...
  def setup_kernel_apt_sources(self, target, version):
    ...
    if target[Key.ORIGIN.value] not in "devuan" "debian" "armbian" "firmwaretoolkit" "custom":
...
#          working_file.write(" main firmwaretoolkit\n")
          working_file.write("deb [trusted=yes] http://192.168.11.128/firmwaretoolkit " + version + " debian firmwaretoolkit/mainline\n") 
