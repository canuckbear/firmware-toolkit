# u-boot installation for raspberry-pi0-2
...
. The commands are run on the target board (raspberry-pi0-2)
...
sudo dd if=/boot/u-boot/u-boot-raspberry-pi0-2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
