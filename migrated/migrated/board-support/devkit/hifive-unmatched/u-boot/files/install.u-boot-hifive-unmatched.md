# u-boot installation for hifive-unmatched
...
/boot/u-boot/u-boot-hifive-unmatched

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-hifive-unmatched.VERSION
...
. The commands are run on the target board (hifive-unmatched)
...
sudo dd if=/boot/u-boot/u-boot-hifive-unmatched of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
