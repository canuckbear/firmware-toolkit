# u-boot installation for raspberry-pi3
...
. The commands are run on the target board (raspberry-pi3)
...
# sudo dd if=/boot/u-boot/u-boot-raspberry-pi3 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
