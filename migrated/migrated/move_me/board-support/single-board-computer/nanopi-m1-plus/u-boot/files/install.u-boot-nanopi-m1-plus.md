# u-boot installation for nanopi-m1-plus
...
. The commands are run on the target board (nanopi-m1-plus)
...
sudo dd if=/boot/u-boot/u-boot-nanopi-m1-plus of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
