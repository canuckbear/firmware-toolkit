# u-boot installation for nanopi-k2
...
. The commands are run on the target board (nanopi-k2)
...
sudo dd if=/boot/u-boot/u-boot-nanopi-k2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
