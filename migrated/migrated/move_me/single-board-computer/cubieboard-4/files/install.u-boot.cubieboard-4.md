# u-boot installation for cubieboard-4
...
. The commands are run on the target board (cubieboard-4)
...
sudo dd if=/boot/u-boot/u-boot-cubieboard-4 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
