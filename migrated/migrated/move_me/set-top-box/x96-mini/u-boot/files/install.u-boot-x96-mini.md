# u-boot installation for x96-mini
...
. The commands are run on the target board (x96-mini)
...
sudo dd if=/boot/u-boot/u-boot-x96-mini of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
