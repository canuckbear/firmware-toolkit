# u-boot installation for nitrogen6-qpmax
...
. The commands are run on the target board (nitrogen6-qpmax)
...
# sudo dd if=/boot/u-boot/u-boot-nitrogen6-qpmax of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
