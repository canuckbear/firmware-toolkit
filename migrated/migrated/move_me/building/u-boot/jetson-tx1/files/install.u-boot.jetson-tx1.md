# u-boot installation for jetson-tx1
...
. The commands are run on the target board (jetson-tx1)
...
# sudo dd if=/boot/u-boot/u-boot-jetson-tx1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
