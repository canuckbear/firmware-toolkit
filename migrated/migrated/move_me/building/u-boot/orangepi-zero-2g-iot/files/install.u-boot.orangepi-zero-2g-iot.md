# u-boot installation for orangepi-zero-2g-iot
...
/boot/u-boot/u-boot-orangepi-zero-2g-iot

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-orangepi-zero-2g-iot.VERSION
...
. The commands are run on the target board (orangepi-zero-2g-iot)
...
# sudo dd if=/boot/u-boot/u-boot-orangepi-zero-2g-iot of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
