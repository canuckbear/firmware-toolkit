# u-boot installation for nanopi-m1
...
. The commands are run on the target board (nanopi-m1)
...
# sudo dd if=/boot/u-boot/u-boot-nanopi-m1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
