# u-boot installation for nanopi-neo
...
. The commands are run on the target board (nanopi-neo)
...
# sudo dd if=/boot/u-boot/u-boot-nanopi-neo of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
