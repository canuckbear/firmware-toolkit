# u-boot installation for jetson-tk1
...
. The commands are run on the target board (jetson-tk1)
...
sudo dd if=/boot/u-boot/u-boot-jetson-tk1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
