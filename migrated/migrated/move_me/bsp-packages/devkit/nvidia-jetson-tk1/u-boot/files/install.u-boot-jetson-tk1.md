# u-boot installation for nvidia-jetson-tk1
...
/boot/u-boot/u-boot-nvidia-jetson-tk1

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-nvidia-jetson-tk1.VERSION
...
. The commands are run on the target board (nvidia-jetson-tk1)
...
sudo dd if=/boot/u-boot/u-boot-nvidia-jetson-tk1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
