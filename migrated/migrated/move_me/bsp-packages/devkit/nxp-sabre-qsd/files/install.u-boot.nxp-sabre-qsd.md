# u-boot installation for sabre-qsd
...
. The commands are run on the target board (sabre-qsd)
...
# sudo dd if=/boot/u-boot/u-boot-sabre-qsd of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
