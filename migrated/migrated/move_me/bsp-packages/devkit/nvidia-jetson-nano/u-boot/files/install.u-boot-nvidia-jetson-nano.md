# u-boot installation for nvidia-jetson-nano
...
/boot/u-boot/u-boot-nvidia-jetson-nano

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-nvidia-jetson-nano.VERSION
...
. The commands are run on the target board (nvidia-jetson-nano)
...
sudo dd if=/boot/u-boot/u-boot-nvidia-jetson-nano of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
