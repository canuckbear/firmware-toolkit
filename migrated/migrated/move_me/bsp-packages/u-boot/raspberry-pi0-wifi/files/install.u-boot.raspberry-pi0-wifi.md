# u-boot installation for raspberry-pi0-wifi
...
/boot/u-boot/u-boot-raspberry-pi0-wifi

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-raspberry-pi0-wifi.VERSION
...
. The commands are run on the target board (raspberry-pi0-wifi)
...
# sudo dd if=/boot/u-boot/u-boot-raspberry-pi0-wifi of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
