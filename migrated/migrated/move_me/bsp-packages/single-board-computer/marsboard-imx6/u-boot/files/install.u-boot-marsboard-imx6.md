# u-boot installation for marsboard-imx6
...
. The commands are run on the target board (marsboard-imx6)
...
sudo dd if=/boot/u-boot/u-boot-marsboard-imx6 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
