# u-boot installation for 96boards-rock960
...
/boot/u-boot/u-boot-96boards-rock960

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-96boards-rock960.VERSION
...
. The commands are run on the target board (96boards-rock960)
...
sudo dd if=/boot/u-boot/u-boot-96boards-rock960 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
