# u-boot installation for orangepi-3
...
. The commands are run on the target board (orangepi-3)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-3 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
