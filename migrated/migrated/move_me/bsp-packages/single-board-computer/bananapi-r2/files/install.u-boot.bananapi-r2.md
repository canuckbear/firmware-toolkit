# u-boot installation for bananapi-r2
...
. The commands are run on the target board (bananapi-r2)
...
# sudo dd if=/boot/u-boot/u-boot-bananapi-r2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
