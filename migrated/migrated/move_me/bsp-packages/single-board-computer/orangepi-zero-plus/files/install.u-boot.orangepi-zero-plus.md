# u-boot installation for orangepi-zero-plus
...
/boot/u-boot/u-boot-orangepi-zero-plus

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-orangepi-zero-plus.VERSION
...
. The commands are run on the target board (orangepi-zero-plus)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-zero-plus of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
