# u-boot installation for nitrogen-8m
...
. The commands are run on the target board (nitrogen-8m)
...
sudo dd if=/boot/u-boot/u-boot-nitrogen-8m of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
