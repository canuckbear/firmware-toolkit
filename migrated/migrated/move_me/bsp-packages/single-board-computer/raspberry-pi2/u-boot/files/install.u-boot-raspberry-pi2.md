# u-boot installation for raspberry-pi2
...
. The commands are run on the target board (raspberry-pi2)
...
sudo dd if=/boot/u-boot/u-boot-raspberry-pi2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
