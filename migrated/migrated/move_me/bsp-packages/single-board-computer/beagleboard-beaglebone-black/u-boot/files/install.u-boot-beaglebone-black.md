# u-boot installation for beaglebone-black
...
/boot/u-boot/u-boot-beaglebone-black

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-beaglebone-black.VERSION
...
. The commands are run on the target board (beaglebone-black)
...
sudo dd if=/boot/u-boot/u-boot-beaglebone-black of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
