# u-boot installation for raspberry-pi3-32bits
...
/boot/u-boot/u-boot-raspberry-pi3-32bits

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-raspberry-pi3-32bits.VERSION
...
. The commands are run on the target board (raspberry-pi3-32bits)
...
# sudo dd if=/boot/u-boot/u-boot-raspberry-pi3-32bits of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
