# u-boot installation for raspberry-pi0w
...
. The commands are run on the target board (raspberry-pi0w)
...
# sudo dd if=/boot/u-boot/u-boot-raspberry-pi0w of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
