# u-boot installation for pine64-h64
...
. The commands are run on the target board (pine64-h64)
...
sudo dd if=/boot/u-boot/u-boot-pine64-h64 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
