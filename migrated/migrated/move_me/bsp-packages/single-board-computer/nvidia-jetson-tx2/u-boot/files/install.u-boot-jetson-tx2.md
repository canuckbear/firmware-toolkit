# u-boot installation for nvidia-jetson-tx2 
...
/boot/u-boot/u-boot-nvidia-jetson-tx2
...
. The commands are run on the target board (nvidia-jetson-tx2)
...
sudo dd if=/boot/u-boot/u-boot-nvidia-jetson-tx2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
