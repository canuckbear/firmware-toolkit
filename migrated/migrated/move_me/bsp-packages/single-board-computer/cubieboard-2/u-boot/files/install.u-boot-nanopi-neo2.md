# u-boot installation for nanopi-neo2
...
. The commands are run on the target board (nanopi-neo2)
...
sudo dd if=/boot/u-boot/u-boot-nanopi-neo2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
