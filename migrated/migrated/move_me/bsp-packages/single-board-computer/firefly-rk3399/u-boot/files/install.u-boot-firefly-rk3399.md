# u-boot installation for firefly-rk3399
...
. The commands are run on the target board (firefly-rk3399)
...
sudo dd if=/boot/u-boot/u-boot-firefly-rk3399 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
