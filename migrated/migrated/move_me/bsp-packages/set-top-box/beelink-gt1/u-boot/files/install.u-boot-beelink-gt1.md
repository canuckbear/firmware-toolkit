# u-boot installation for beelink-gt1
...
. The commands are run on the target board (beelink-gt1)
...
sudo dd if=/boot/u-boot/u-boot-beelink-gt1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
