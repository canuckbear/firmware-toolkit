# u-boot installation for sunvell-t95max
...
. The commands are run on the target board (sunvell-t95max)
...
sudo dd if=/boot/u-boot/u-boot-sunvell-t95max of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
