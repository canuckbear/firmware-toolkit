# u-boot installation for tanix-tx3
...
. The commands are run on the target board (tanix-tx3)
...
sudo dd if=/boot/u-boot/u-boot-tanix-tx3 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
