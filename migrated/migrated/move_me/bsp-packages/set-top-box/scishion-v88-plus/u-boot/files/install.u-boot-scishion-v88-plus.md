# u-boot installation for scishion-v88-plus
...
/boot/u-boot/u-boot-scishion-v88-plus

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-scishion-v88-plus.VERSION
...
. The commands are run on the target board (scishion-v88-plus)
...
sudo dd if=/boot/u-boot/u-boot-scishion-v88-plus of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
