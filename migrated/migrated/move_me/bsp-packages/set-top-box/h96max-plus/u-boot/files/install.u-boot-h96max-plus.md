# u-boot installation for h96max-plus
...
. The commands are run on the target board (h96max-plus)
...
sudo dd if=/boot/u-boot/u-boot-h96max-plus of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
