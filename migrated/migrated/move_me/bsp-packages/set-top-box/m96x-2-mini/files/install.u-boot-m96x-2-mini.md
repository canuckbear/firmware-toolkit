# u-boot installation for m96x-2-mini
...
. The commands are run on the target board (m96x-2-mini)
...
sudo dd if=/boot/u-boot/u-boot-m96x-2-mini of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
