# u-boot installation for beelink-gt1-ultimate
...
/boot/u-boot/u-boot-beelink-gt1-ultimate

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-beelink-gt1-ultimate.VERSION
...
. The commands are run on the target board (beelink-gt1-ultimate)
...
sudo dd if=/boot/u-boot/u-boot-beelink-gt1-ultimate of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
