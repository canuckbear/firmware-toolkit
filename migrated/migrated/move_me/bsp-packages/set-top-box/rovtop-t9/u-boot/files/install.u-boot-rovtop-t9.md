# u-boot installation for rovtop-t9
...
. The commands are run on the target board (rovtop-t9)
...
sudo dd if=/boot/u-boot/u-boot-rovtop-t9 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
