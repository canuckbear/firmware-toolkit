# u-boot installation for pinebook
...
. The commands are run on the target board (pinebook)
...
# sudo dd if=/boot/u-boot/u-boot-pinebook of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
