# u-boot installation for nezha-d1
...
. The commands are run on the target board (nezha-d1)
...
sudo dd if=/boot/u-boot/u-boot-nezha-d1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
