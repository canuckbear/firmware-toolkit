# u-boot installation for alfawise-s95
...
. The commands are run on the target board (alfawise-s95)
...
sudo dd if=/boot/u-boot/u-boot-alfawise-s95 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer
