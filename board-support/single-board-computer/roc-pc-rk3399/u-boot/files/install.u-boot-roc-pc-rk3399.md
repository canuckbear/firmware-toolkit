# u-boot installation for roc-pc-rk3399
...
. The commands are run on the target board (roc-pc-rk3399)
...
sudo dd if=/boot/u-boot/u-boot-roc-pc-rk3399 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
