# u-boot installation for pine64-avoata-a1
...
/boot/u-boot/u-boot-pine64-avoata-a1

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-pine64-avoata-a1.VERSION
...
. The commands are run on the target board (pine64-avoata-a1)
...
sudo dd if=/boot/u-boot/u-boot-pine64-avoata-a1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
