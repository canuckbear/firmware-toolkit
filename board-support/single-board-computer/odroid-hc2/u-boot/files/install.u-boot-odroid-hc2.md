# u-boot installation for odroid-hc2
...
. The commands are run on the target board (odroid-hc2)
...
sudo dd if=/boot/u-boot/u-boot-odroid-hc2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
