# u-boot installation for orangepi-zero-2
...
. The commands are run on the target board (orangepi-zero-2)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-zero-2 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
