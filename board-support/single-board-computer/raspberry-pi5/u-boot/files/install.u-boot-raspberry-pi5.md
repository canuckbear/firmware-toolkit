# u-boot installation for raspberry-pi5
...
. The commands are run on the target board (raspberry-pi5)
...
sudo dd if=/boot/u-boot/u-boot-raspberry-pi5 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
