...
. The commands are run on the target board (oz64)
...
sudo dd if=/boot/u-boot/u-boot-oz64 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
