# u-boot installation for star64
...
. The commands are run on the target board (star64)
...
sudo dd if=/boot/u-boot/u-boot-star64 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
