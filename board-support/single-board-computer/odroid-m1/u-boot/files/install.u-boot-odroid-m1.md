# u-boot installation for odroid-m1
...
. The commands are run on the target board (odroid-m1)
...
sudo dd if=/boot/u-boot/u-boot-odroid-m1 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
