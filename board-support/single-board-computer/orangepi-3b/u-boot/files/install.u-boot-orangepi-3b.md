# u-boot installation for orangepi-3b
...
. The commands are run on the target board (orangepi-3b)
...
sudo dd if=/boot/u-boot/u-boot-orangepi-3b of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
