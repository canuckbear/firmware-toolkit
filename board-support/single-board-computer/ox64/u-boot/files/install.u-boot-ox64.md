...
. The commands are run on the target board (ox64)
...
sudo dd if=/boot/u-boot/u-boot-ox64 of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
