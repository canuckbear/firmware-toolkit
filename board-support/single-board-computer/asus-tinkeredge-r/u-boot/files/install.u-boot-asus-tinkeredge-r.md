# u-boot installation for asus-tinkeredge-r
...
/boot/u-boot/u-boot-asus-tinkeredge-r

This is a symlink to the current u-boot file stored at the same location in a
file named u-boot-asus-tinkeredge-r.VERSION
...
. The commands are run on the target board (asus-tinkeredge-r)
...
sudo dd if=/boot/u-boot/u-boot-asus-tinkeredge-r of=/dev/mmcblk0 bs=1024 seek=8 status=noxfer conv=nocreat,notrunc
